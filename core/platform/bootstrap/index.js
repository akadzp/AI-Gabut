...
import { createOperationsRuntime } from "../operations/index.js";
...
export async function bootstrap({ start, stop, environment = {}, configuration = {}, loggerSink = console } = {}) {
  ...
  runtime.operations = createOperationsRuntime({
    lifecycle: runtime.lifecycle,
  ...
  runtime.dependencies.register("operations", runtime.operations);
  ...
  runtime.registry = new CapabilityRegistry()
    ...
    .register("platform.operations", runtime.operations, { domain: "platform", type: "operations" });
  ...
  runtime.diagnostics.record({
    ...
    metadata: { identity: runtime.identity.id }
  });

  return {
    ...runtime,
    stop: async () => runtime.operations.shutdown(
      async () => runtime.lifecycle.stop(
        stop ? () => stop(runtime.server) : undefined
      ),
      { timeoutMs: runtime.configuration.shutdownTimeoutMs }
    )
  };
}
